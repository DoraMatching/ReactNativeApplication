...
import BlogFormEdit from './BlogFormEdit.container';

var screen = Dimensions.get("window");
export default class BlogFormEditModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLiked: false,
  ...
  id;
  token;
  showBlogFormEditModal = ({id, token}) => {
  ...
  render() {
    ...
    return (
      ...
      <Modal
        ref={this.setBlogFormEditModalRef}
        swipeToClose={false}
        ...
        isOpen={this.state.isOpen}>
          ...
          <BlogFormEdit onClose={this.onClose} onOpen={this.onOpen} id={this.id} token = {this.token}></BlogFormEdit>
          <View
              style={{
                flexDirection: "row",
