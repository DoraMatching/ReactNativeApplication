const Actions = {
  ...
  GET_PROFILE_INFO_CLASSROOM_NEW: "GET_PROFILE_INFO_CLASSROOM_NEW",

  GET_PROFILE_INFO_CLASSROOM_NEW_SUCCEEDED: "GET_PROFILE_INFO_CLASSROOM_NEW_SUCCEEDED",
  GET_PROFILE_INFO_CLASSROOM_NEW_FAILED: "GET_PROFILE_INFO_CLASSROOM_NEW_FAILED",
  ...
  getProfileClassroomNewAction: (params) => {
    return {
      type: Actions.GET_PROFILE_INFO_CLASSROOM_NEW,
      params,
    };
  },

  getProfileClassroomNewSuccessAction: (data) => {
    return {
  ...
  getProfileClassroomNewFailedAction: (error) => {
    return {
