...
const TopicDetailReducer = (data = null, action) => {
  ...
  const TopicClassReducer = (data = null, action) => {
    switch (action.type) {
      case Actions.GET_TOPIC_CLASS_SUCCEEDED:
        //console.log("get user success", action.data);
        return action.data;
      ...
      //   if (data) data.posts.unshift(action.data);
      //   return data;
      case Actions.GET_TOPIC_CLASS_FAILED:
        return data;
  ...
  export {TopicDetailReducer, TopicClassReducer}