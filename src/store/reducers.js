...
import {
  BlogTopReducer,
  BlogTopItemReducer,
} from "../screens/BlogSearch/BlogSearch.reducers";
import {
  BlogDetailReducer,
  BlogCommentReducer,
} from "../screens/BlogDetail/BlogDetail.reducers";
import {BlogFormReducer} from "../screens/BlogForm/BlogForm.reducers";
import {
  BlogFormEditReducer,
  EditReducer,
} from "../screens/BlogFormEdit/BlogFormEdit.reducers";

import {
  QuestionTopItemReducer,
  QuestionTopReducer,
} from "../screens/QuestionSearch/QuestionSearch.reducers";
import {
  QuestionDetailReducer,
  QuestionCommentReducer,
} from "../screens/QuestionDetail/QuestionDetail.reducers";
import {QuestionFormReducer} from "../screens/QuestionForm/QuestionForm.reducers";
import {
  QuestionFormEditReducer,
  QuestionEditReducer,
} from "../screens/QuestionFormEdit/QuestionFormEdit.reducers";
...
} from "../screens/Profile/Profile.reducers";
...
import {
  ...
  ClassDetailModal,
} from "../screens/ProfileInfo/ProfileInfo.reducers";

import {
  LessonReducer,
  LessonFormReducer,
  LessonDetailReducer,
} from "../screens/LessonForm/LessonForm.reducers";

import {TopicFormReducer} from "../screens/TopicForm/TopicForm.reducers";
import {
  TopicTopItemReducer,
  TopicTopReducer,
} from "../screens/TopicSearch/TopicSearch.reducers";
import {
  TopicDetailReducer,
  TopicClassReducer,
} from "../screens/TopicDetail/TopicDetail.reducers";
...
import {
  ...
  TrainerTopReducer,
} from "../screens/TrainerSearch/TrainerSearch.reducers";
...
} from "../screens/ClassDetail/ClassDetail.reducers";
...
import {
  ClassSearchReducer,
  ClassSearchItemReducer,
} from "../screens/ClassSearch/ClassSearch.reducers";
